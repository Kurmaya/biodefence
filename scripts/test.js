...
// test
const torusGeo = new THREE.TorusGeometry(2.6,.5,10,100,3.15);

const cylinderGeometry = new THREE.CylinderGeometry(.6,.57,3.4,30,30);
...
cylinder.position.set(-1.9,1.6,-2);
cylinder2.position.set(-1.9,-1.6,-2);
...
gui.add(torus.rotation,'z',0,Math.PI).name('torus1 z rotation');
gui.add(torus2.rotation,'z',0,Math.PI).name('torus2 z rotation');
